...
> **⚠️ Note on notebook rendering:** GitHub does not render large Jupyter notebooks fully in the browser. Sections 10 (SHAP) and 11 (Final Summary) may not be visible when viewing the notebook on GitHub. To see the complete notebook with all outputs, please download the file and open it locally, or view it directly on [Kaggle](https://www.kaggle.com/code/daniilhontar/cnn-crowd-density) where it was originally run.
